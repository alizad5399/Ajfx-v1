...
Asena.addCommand({pattern: 'setvar', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://i.imgur.com/7AreZxA.jpeg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━༒︎SETVAR༒︎━━⛦
𝐇𝐀𝐈 𝐈 𝐀𝐌 𝐀𝐉𝐅𝐗 𝐁𝐎𝐓.
