...
module.exports = {
    ...
    SESSION: process.env.AJFX_QR_CODE === undefined ? '' : process.env.AJFX_QR_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    FAKE: process.env.FAKE_REMOVE === undefined ? 'false' : process.env.FAKE_REMOVE,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/7AreZxA.jpeg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    GITMSG: process.env.GIT_MESSAGE === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴀᴊғx' : process.env.GIT_MESSAGE,
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ᴀᴊғx*' : process.env.ALL_CAPTION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ᴀᴊғx*' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/7AreZxA.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ᴀᴊғx' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴀᴊғx ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    SED: process.env.SED_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ᴀᴊғx*' : process.env.SED_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ᴀᴊғx' : process.env.BOT_NAME,
    ...
    SKV: process.env.V_HEADER === undefined ? '*ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴀᴊғx*' : process.env.V_HEADER,
